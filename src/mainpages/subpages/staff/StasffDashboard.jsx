...
function StaffDashboard() {
    ...
    const getUserInitials = () => {
        if (!userData) return { firstInitial: "S", secondInitial: "T" };
        ...
        // Ensure we always have at least "ST" as fallback
        if (!firstInitial) firstInitial = "S";
        if (!secondInitial) secondInitial = "T";
                                ...
                                <div className="user_row profile">
                                    ...
                                    <div className="password_choice mt-3">
                                        <div className="form-floating mb-3">
                                            <input type="password" className="form-control" id="staffOldPassword" placeholder="Old Password" />
                                            <label htmlFor="staffOldPassword">Old Password</label>
                                        </div>
                                        <div className="form-floating mb-3">
                                            <input type="password" className="form-control" id="staffNewPassword" placeholder="New Password" />
